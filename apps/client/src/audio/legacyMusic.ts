// TEMPORARY COMPATIBILITY FALLBACK: remove this module once the rendered gameplay stems are supplied.
// This preserves the previous procedural BGM only to avoid complete silence while assets are missing.
