...
export const TILE_STEP_PRESS_DEPTH = 0.046;
export const TILE_LAND_PRESS_DEPTH = 0.072;
export const TILE_STEP_PRESS_DARKENING = 0.09;
export const TILE_LAND_PRESS_DARKENING = 0.14;
