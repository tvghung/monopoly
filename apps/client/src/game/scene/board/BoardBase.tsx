...
export default function BoardBase() {
  ...
  return (
    <group>
      ...
      <mesh position={[0, PLATFORM_HEIGHT + 0.025, 0]} receiveShadow>
        <boxGeometry args={[CENTER_SIZE, 0.08, CENTER_SIZE]} />
        <meshStandardMaterial color={boardVisualTokens.boardCenter} roughness={0.82} />
      </mesh>
      <mesh position={[0, PLATFORM_HEIGHT + RIM_HEIGHT / 2, -rimExtent]} receiveShadow>
      ...
      <mesh position={[-rimExtent, PLATFORM_HEIGHT + RIM_HEIGHT / 2, 0]} receiveShadow>
