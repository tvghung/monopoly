...
`SOCKET_PROTOCOL_VERSION = 3`. Compile-time types và Zod validation runtime là hai
...
Persistence snapshot v3 chứa authoritative turn/payment operations nhưng không
