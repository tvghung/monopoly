...
`SOCKET_PROTOCOL_VERSION = 5`. Compile-time types và Zod validation runtime là hai
...
Persistence snapshot v5 chứa authoritative turn/payment operations cùng
`CharacterId`/`PlayerColorId`, nhưng không chứa presence/socket/timer handle. Mọi
