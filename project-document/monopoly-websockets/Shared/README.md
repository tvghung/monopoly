...
`SOCKET_PROTOCOL_VERSION = 2`. Compile-time types và Zod validation runtime là hai
...
Persistence snapshot v2 chứa authoritative Standard Mode operations nhưng không
